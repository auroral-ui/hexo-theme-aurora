    ...
    <transition name="fade-slide-y" mode="out-in">
      <div class="search-container" v-if="openSearchContainer">
        ...
        <div
          ...
          v-if="searchResults.length > 0 || recentResults.length > 0"
        >
          <div>
            <section v-if="searchResults.length > 0">
              <div class="search-hit-label">
                Records found
                <span class="text-ob">{{ searchResultsCount }}</span>
              </div>
              <ul id="search-menu">
                <li
            ...
            <section v-else>
              <div class="search-hit-label">Recently searched</div>
              <ul id="search-menu">
                <li
        ...
        <div class="search-footer">
          ...
          <ul class="search-commands">
            <li>
              ...
              <span class="search-commands-label">to select</span>
            </li>
            <li>
              <span class="search-commands-key">
                <svg width="15" height="15">
              ...
              <span class="search-commands-label">to navigate</span>
            </li>
            <li>
              <span class="search-commands-key">
                <svg width="15" height="15">
              ...
              <span class="search-commands-label">to close</span>
            </li>
          </ul>
        </div>
      </div>
